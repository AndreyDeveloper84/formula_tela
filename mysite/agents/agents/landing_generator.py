                ...
                messages=[
                    {
                        "role": "system",
                        "content": (
                            "Ты SEO-копирайтер и growth-специалист салона красоты в Пензе. "
                            "Пишешь контент, который решает боли клиента и конвертирует в запись. "
                            "Учитываешь локальное SEO (Пенза) и поведенческие факторы. "
